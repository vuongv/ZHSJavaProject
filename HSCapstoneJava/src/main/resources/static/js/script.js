...
function sortOrderTableByStatus() {
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
  table = document.getElementById("orderTable");
  switching = true;
...
function sortImageTableByDisplay() {
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
  table = document.getElementById("imageTable");
  switching = true;
...
function sortTestimonialTableById() {
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
...
function sortTestimonialTableByServiceName() {
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
  table = document.getElementById("testimonialTable");
  switching = true;
...
function sortTestimonialTableByUserName() {
  var table, rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;
  table = document.getElementById("testimonialTable");
  switching = true;
